        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-[1280px] mx-auto">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[11px] font-semibold tracking-wide uppercase px-2.5 py-1 rounded-full bg-[rgba(124,58,237,0.1)] text-[#8b5cf6] border border-[rgba(124,58,237,0.2)]">Linkedin Live</span>
            </div>
            <h3 className="text-lg font-bold text-[#f8fafc] mb-2 group-hover:text-[#a855f7] transition-colors leading-snug">
              AI-Augmented Web3 Infrastructure: Building Smarter Blockchains
            </h3>
            <p className="text-[13px] text-[#64748b] leading-relaxed mb-4">
              This session is focusing on how AI and Web3 infrastructure are evolving together, the growing role of intelligent blockchain systems and what it takes to build scalable technologies that can support real-world adoption.
              The discussion also covers practical insights around Layer-1 architecture, DeFi ecosystems, payments and tokenization.
            </p>
