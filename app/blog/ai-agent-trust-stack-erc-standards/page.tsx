...
const linkCls =
  "text-[#6f8fa3] hover:text-[#c2703f] transition-colors underline underline-offset-4";
        ...
        <header className="relative py-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-28 md:py-36">
            <div className="flex flex-wrap items-center gap-3 mb-10">
              ...
              <span className="text-[11px] text-[#5c5644]">30 min read · Advanced</span>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 py-24 md:py-32">
          <div className="space-y-24">
            ...
            <section id="anonymity-problem">
              ...
              <div className="space-y-6">
                ...
                <div className="my-10 pl-6 md:pl-8 border-l-[3px] border-[#c2703f] bg-[rgba(194,112,63,0.05)] rounded-r-lg p-6 md:p-8 relative">
                  ...
                  <cite className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] not-italic">— On the Agent Trust Gap</cite>
                </div>
              </div>
            </section>
            ...
            <section id="trust-stack-overview">
              ...
              <div className="space-y-6">
                  ...
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#ddd0b2]">
                        ...
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">Standard</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">Status</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">Anchors</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">Prevents</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                ...
                <div className="bg-[rgba(185,138,61,0.06)] border border-[rgba(185,138,61,0.15)] rounded-xl p-6 md:p-8">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#b98a3d] mb-3">Standards Maturity Inversion</div>
                  <p className="text-sm text-[#5c5644] leading-relaxed">
                    Both ERC-8126 and ERC-8196 formally list <a href="https://eips.ethereum.org/EIPS/eip-8004" target="_blank" rel="noopener noreferrer" className={linkCls}>EIP-8004</a> in their <code className="text-[#201c14]">Requires</code> field, and both have reached <strong className="text-[#201c14]">Final</strong> status. EIP-8004 itself remains <strong className="text-[#201c14]">Draft</strong>. In practice, the verification and execution layers of this stack standardized faster than the identity layer they formally depend on — worth knowing before you commit production infrastructure to the assumption that agentId resolution is a settled interface.
                  </p>
                </div>

                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  <a href="https://eips.ethereum.org/EIPS/eip-8004" target="_blank" rel="noopener noreferrer" className={linkCls}>ERC-8004, &quot;Trustless Agents,&quot;</a> is the connective tissue underneath everything that follows, so it is worth a paragraph even though it is not one of the four standards this article centers on. It defines three registries on top of ERC-721: an Identity Registry that assigns each agent a globally unique <code className="text-[#201c14]">agentId</code> combining namespace, chain ID, and contract address, whose <code className="text-[#201c14]">tokenURI</code> (called the agentURI) resolves to a JSON registration file with endpoints and supported trust models; a Reputation Registry where any client can submit numerical feedback signals; and a Validation Registry where independent validators — including ERC-8126 verification providers — can record auditable verification results. Every function name referenced in the sections below that takes an <code className="text-[#201c14]">agentId</code> parameter is, ultimately, resolving against this registry.
                </p>
              </div>
            </section>
            ...
            <section id="erc-7662-agent-nfts">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">03 · Identity &amp; IP</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-xl overflow-hidden my-8">
                  <div className="flex items-center justify-between px-5 py-3 border-b border-[#ddd0b2] bg-[rgba(32,28,20,0.02)]">
                    <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">IERC7662 — extends IERC721</span>
                  </div>
...
{`interface IERC7662 is IERC721 {
    ...
    event AgentUpdated(uint256 indexed tokenId);
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  Each token carries a <code className="text-[#201c14]">model</code> identifier (for example <code className="text-[#201c14]">gpt-4-0125-preview</code> or <code className="text-[#201c14]">claude-3-opus-20240229</code>), and two URIs — <code className="text-[#201c14]">userPromptURI</code> and <code className="text-[#201c14]">systemPromptURI</code> — pointing at decentralized storage. The recommended architecture encrypts both before upload and ties decryption capability to <code className="text-[#201c14]">ownerOf(tokenId)</code>, so that transferring the NFT transfers decryption rights atomically with ownership — the same trick NFT-gated content platforms use, applied to a prompt instead of a media file. The standard also mandates a <code className="text-[#201c14]">{"${variableName}"}</code> syntax for injectable runtime parameters, so downstream tooling — a web form, an agent runtime, an MCP server — can recognize and substitute dynamic values without parsing free text.
                </p>

                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  The limitation is structural, not incidental: mapping-tied encryption is a convention, not a proof. Nothing in ERC-7662 requires a seller to have actually re-encrypted the underlying data for the buyer&apos;s key at the moment of transfer — <code className="text-[#201c14]">transferFrom()</code> only moves a token ID, and says nothing about the payload it is supposed to represent. A buyer has no cryptographic way to confirm the encrypted content they now &quot;own&quot; is current, correctly re-keyed, or not simply corrupted. That gap is exactly what the next standard closes.
                </p>
              </div>
            </section>
            ...
            <section id="erc-7857-private-metadata">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">04 · Verifiable Transfer</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
...
struct TransferValidityProof {
    ...
    OwnershipProof ownershipProof;
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  The main <code className="text-[#201c14]">IERC7857</code> interface exposes four distinct operations, each answering a different question about who can do what with an agent&apos;s data: <code className="text-[#201c14]">iTransfer()</code> moves ownership and re-encrypts the underlying data for the recipient, verified through a <code className="text-[#201c14]">TransferValidityProof[]</code>; <code className="text-[#201c14]">iClone()</code> duplicates the data to a new token while the original owner retains theirs — useful for licensing a fine-tuned copy of an agent without losing the master; <code className="text-[#201c14]">authorizeUsage()</code> grants usage rights without transferring ownership at all, the equivalent of renting an agent rather than buying it; and <code className="text-[#201c14]">delegateAccess()</code> assigns an assistant for access verification, foreshadowing the execution-delegation problem ERC-8196 solves in full.
                </p>
                ...
                <div className="overflow-x-auto my-10">
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#ddd0b2]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">Property</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">TEE-based prover</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">ZKP-based prover</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  Replay protection relies on nonce tracking with a time-bounded expiration window, cleared via <code className="text-[#201c14]">cleanExpiredProofs()</code>; sealed-key changes and ownership changes are required to be atomic and independently verifiable, so a proof cannot be partially applied.
                </p>

                <div className="bg-[rgba(111,143,163,0.06)] border border-[rgba(111,143,163,0.15)] rounded-xl p-6 md:p-8">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3] mb-3">Ownership vs. Data — Deliberately Decoupled</div>
                  <p className="text-sm text-[#5c5644] leading-relaxed">
                    An NFT can change hands without the underlying agent data moving at all — that is what <code className="text-[#201c14]">authorizeUsage()</code> is for. And data can be provably duplicated without any transfer of ownership — that is what <code className="text-[#201c14]">iClone()</code> is for. Vanilla ERC-721 conflates &quot;who owns the token&quot; with &quot;who possesses the asset.&quot; ERC-7857 deliberately splits control from possession, because an agent&apos;s IP has licensing and derivative-work economics a static image or collectible never had to model.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="erc-8126-verification">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">05 · Verification</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  Owning a well-encrypted, provably-transferable agent NFT says nothing about whether that specific agent is safe to interact with today. <a href="https://eips.ethereum.org/EIPS/eip-8126" target="_blank" rel="noopener noreferrer" className={linkCls}>ERC-8126, &quot;AI Agent Verification,&quot;</a> is the layer that answers exactly that — deliberately specified as an <strong className="text-[#201c14]">off-chain verification standard</strong> with an optional on-chain attestation hook, so routine checks don&apos;t need to be gas-metered to be standardized.
                </p>
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  The flow is mandatory and deliberately closes a spoofing hole: a verification provider <strong className="text-[#201c14]">must</strong> call <code className="text-[#201c14]">tokenURI(agentId)</code> on the ERC-8004 Identity Registry and resolve the returned metadata — direct parameter submission without an <code className="text-[#201c14]">agentId</code> is explicitly prohibited. This means a verifier can never be tricked into scoring metadata that was never actually bound to the agent on-chain.
                </p>
                ...
                <div className="overflow-x-auto my-10">
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#ddd0b2]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">Check</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">What It Verifies</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">Attack It Mitigates</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  The overall risk score is the arithmetic mean of the five sub-scores on a 0–100 scale, bucketed for straightforward interpretation: 0–20 low risk, 21–40 moderate, 41–60 elevated, 61–80 high, 81–100 critical. Two optional layers extend this: <strong className="text-[#201c14]">Private Data Verification (PDV)</strong> generates zero-knowledge proofs of the verification results without exposing the underlying sensitive data, which matters for GDPR-adjacent compliance and eliminates a whole category of breach risk; and <strong className="text-[#201c14]">Quantum Cryptography Verification (QCV)</strong>, an optional quantum-resistant layer using AES-256-GCM that returns an encrypted <code className="text-[#201c14]">record_id</code> and <code className="text-[#201c14]">decryption_url</code> for long-horizon security against Shor&apos;s-algorithm-class threats to current elliptic curve cryptography.
                </p>

                <div className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-xl overflow-hidden my-8">
                  <div className="flex items-center justify-between px-5 py-3 border-b border-[#ddd0b2] bg-[rgba(32,28,20,0.02)]">
                    <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">Optional On-Chain Attestation Interface</span>
                  </div>
                  <pre className="p-5 text-[13px] leading-relaxed overflow-x-auto text-[#5c5644]">
{`interface IERC8126 {
    event AgentVerified(
    ...
    function getLatestRiskScore(uint256 agentId) external view returns (uint8);
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  Verification results may optionally post as attestations to ERC-8004&apos;s Validation Registry, making a risk score portable and discoverable across any application that reads the same registry rather than trapped inside one provider&apos;s dashboard. Providers may charge gasless fees using <a href="https://eips.ethereum.org/EIPS/eip-3009" target="_blank" rel="noopener noreferrer" className={linkCls}>EIP-3009</a>&apos;s <code className="text-[#201c14]">TransferWithAuthorization</code> for USDC settlement, and the standard is explicitly provider-agnostic — any entity can implement a compliant verification service, which is meant to produce competition and specialization rather than a single gatekeeper.
                </p>
                ...
                <div className="my-10 pl-6 md:pl-8 border-l-[3px] border-[#6f8fa3] bg-[rgba(111,143,163,0.05)] rounded-r-lg p-6 md:p-8 relative">
                  ...
                  <cite className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] not-italic">— ERC-8126, Security Considerations</cite>
                </div>
            ...
            <section id="erc-8196-policy-execution">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">06 · Execution</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="overflow-x-auto my-10">
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#ddd0b2]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">Policy Field</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">Type</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#6f8fa3]">Purpose</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ...
                        <tr key={i} className="border-b border-[#ddd0b2]/60 hover:bg-[rgba(111,143,163,0.03)] transition-colors">
                          <td className="py-3 px-4 text-[#201c14] font-medium text-[13px] font-mono">{row[0]}</td>
                          <td className="py-3 px-4 text-[#5c5644] font-mono text-[12px]">{row[1]}</td>
                          <td className="py-3 px-4 text-[#5c5644]">{row[2]}</td>
                        </tr>
                      ))}
                ...
                <div className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-xl overflow-hidden my-8">
                  <div className="flex items-center justify-between px-5 py-3 border-b border-[#ddd0b2] bg-[rgba(32,28,20,0.02)]">
                    <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">IAIAgentAuthenticatedWallet — Core Surface</span>
                  </div>
                  <pre className="p-5 text-[13px] leading-relaxed overflow-x-auto text-[#5c5644]">
...
error ValueExceedsLimit(uint256 value, uint256 maxValue);`}
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  Every call to <code className="text-[#201c14]">executeAction()</code> requires an EIP-712-signed action referencing <code className="text-[#201c14]">policyHash</code>, checked against expiration, value caps, and the contract allow/block lists — and critically, against a <strong className="text-[#201c14]">live</strong> call to <code className="text-[#201c14]">getLatestRiskScore(agentId)</code> on ERC-8126. If the agent&apos;s current score has degraded past <code className="text-[#201c14]">minVerificationScore</code> since the policy was registered, execution is rejected automatically — a policy can suspend an agent&apos;s spending authority without any human noticing the degradation first.
                </p>

                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  The <code className="text-[#201c14]">entropyCommitment</code> parameter is the standard&apos;s answer to probabilistic host manipulation: the agent (or its host) commits to a random seed before generating its proposed action, then reveals it at execution time, and the contract checks the reveal against the earlier commitment. A malicious host cannot generate several candidate outputs, see which one would be scored most favorably or execute most profitably for the host, and submit that one after the fact — the randomness is locked in before the model runs.
                </p>

                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  Every executed action is written to a hash-chained audit trail — each <code className="text-[#201c14]">AuditEntryLogged</code> event carries a <code className="text-[#201c14]">previousHash</code>, a sequence number, and a session ID. Implementations may store entries off-chain (IPFS is the natural choice) and anchor periodic Merkle roots on-chain to keep gas costs manageable, while any tampering with the off-chain log breaks the hash chain and is immediately detectable without needing to store every entry on Ethereum itself. <code className="text-[#201c14]">revokePolicy()</code> is callable by the owner at any time, and because every subsequent action requires a live policy check, revocation takes effect immediately — a real kill switch, not a request the agent has to agree to honor.
                </p>

                <div className="bg-[rgba(176,67,47,0.06)] border border-[rgba(176,67,47,0.15)] rounded-xl p-6 md:p-8">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#b0432f] mb-3">Design Principle — CROPS</div>
                  <p className="text-sm text-[#5c5644] leading-relaxed">
            ...
            <section id="composing-the-stack">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">07 · Reference Architecture</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
                  Composing the Stack
                </h2>
              </div>
              <div className="space-y-6">
                ...
                <div className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-xl overflow-hidden my-8">
                  <div className="flex items-center justify-between px-5 py-3 border-b border-[#ddd0b2] bg-[rgba(32,28,20,0.02)]">
                    <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">Composed Lifecycle — Pseudocode</span>
                  </div>
                  <pre className="p-5 text-[13px] leading-relaxed overflow-x-auto text-[#5c5644]">
...
const { success, auditEntryId } = await wallet.executeAction(
  ...
  nonce, entropyCommitment, agentSignature
            ...
            <section id="failure-modes">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-10">
                  {[
                    { title: "Standards Maturity Inversion", color: "#b98a3d", desc: "ERC-8126 and ERC-8196 are Final and formally require ERC-8004, which remains Draft. Production systems are standardizing verification and execution on top of an identity layer whose interface could still change before ratification." },
                    { title: "Who Verifies the Verifier", color: "#b0432f", desc: "ERC-8126 is deliberately provider-agnostic, which means a risk score is only as trustworthy as the provider issuing it. The standard's own security section flags provider collusion as a risk and recommends multi-provider strategies — but doesn't mandate one." },
                    { title: "Entropy Commitment Is a Mitigation, Not a Cure", color: "#b98a3d", desc: "Commit-reveal raises the cost of host manipulation but doesn't eliminate it. A patient adversary controlling the host over many committed runs can still bias outcomes statistically; the standard explicitly frames this as requiring multiple independent hosts for full mitigation." },
                    { title: "The Agent Still Needs a Signing Key", color: "#b0432f", desc: "ERC-8196 removes the need for an agent to hold the delegator's private key, but the agent's own ERC-4337 account still needs a key to produce EIP-712 signatures. Scoped and revocable is a large improvement over unscoped custody — but it is not \"the agent has no key at all.\"" },
                  ].map((panel) => (
            ...
            <section id="conclusion" className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-2xl p-10 md:p-14 text-center">
              ...
              <p className="text-sm text-[#5c5644] leading-relaxed max-w-[800px] mx-auto mb-6">
                None of this makes an anonymous agent trustworthy in the way a KYC&apos;d counterparty is trustworthy. It makes the agent <strong className="text-[#201c14]">verifiably bounded</strong> — a more modest, more honest, and ultimately more useful property for software that has to act at machine speed, across jurisdictions, without a human in every loop.
              </p>
