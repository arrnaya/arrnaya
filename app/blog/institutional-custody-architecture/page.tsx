        ...
        <header className="relative py-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-28 md:py-36">
            <div className="flex flex-wrap items-center gap-3 mb-10">
              ...
              <span className="text-[11px] text-[#94a3b8]">25 min read</span>
            </div>
          ...
          <div className="space-y-24">
            ...
            <div className="space-y-6">
              <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                In traditional finance, custody is understood. Regulated custodians hold bearer instruments in vaulted facilities under well-established legal frameworks, with decades of court precedent establishing what <strong className="text-[#f8fafc]">control</strong> means and who bears liability when it is lost. In digital assets, custody is a cryptographic problem wearing a compliance uniform — and the engineering decisions made at its foundation determine not just operational risk, but whether assets can be recovered at all.
              </p>
              <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
            ...
            <section id="threat-model">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">01 · Security</div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-10">
                  <div className="bg-[#0a0a12] border border-[#1a1a2e] rounded-xl p-6">
                    <h4 className="text-[10px] font-mono tracking-widest uppercase text-[#a855f7] mb-4">External Threat Vectors</h4>
                    <ul className="space-y-3">
                      {[
                        ...
                        <li key={i} className="text-[13px] text-[#94a3b8] leading-relaxed flex items-start gap-2">
                  ...
                  <div className="bg-[#0a0a12] border border-[#1a1a2e] rounded-xl p-6">
                    <h4 className="text-[10px] font-mono tracking-widest uppercase text-[#f59e0b] mb-4">Internal Threat Vectors</h4>
                    <ul className="space-y-3">
                      {[
            ...
            <section id="tss-vs-multisig">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">02 · Cryptography</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                  The first architectural decision is whether multi-party control of assets will be implemented via <strong className="text-[#f8fafc]">threshold signature schemes (TSS)</strong>, a cryptographic technique, or <strong className="text-[#f8fafc]">on-chain multisig</strong>, a smart contract or protocol-level construct.
                </p>
                  ...
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#1a1a2e]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#a855f7]">Dimension</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#a855f7]">TSS / MPC</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#a855f7]">On-Chain Multisig</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                ...
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                  The institutional consensus has moved decisively toward <strong className="text-[#f8fafc]">TSS/MPC</strong> for most use cases. The combination of no single point of cryptographic failure, chain-agnosticism, and on-chain indistinguishability makes it the superior architecture for firms managing diverse asset portfolios under regulatory scrutiny.
                </p>
                ...
                <div className="my-10 pl-6 md:pl-8 border-l-[3px] border-[#a855f7] bg-[rgba(168,85,247,0.05)] rounded-r-lg p-6 md:p-8 relative">
                  ...
                  <cite className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] not-italic">— Design principle, institutional custody engineering</cite>
                </div>
              </div>
            </section>
            ...
            <section id="mpc-cmp">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">03 · Protocol</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#0a0a12] border border-[#1a1a2e] rounded-xl overflow-hidden my-8">
                  <div className="flex items-center gap-2 px-5 py-3 border-b border-[#1a1a2e] bg-[rgba(255,255,255,0.02)]">
                    ...
                    <span className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] ml-2">Protocol · MPC-CMP DKG — Distributed Key Generation</span>
                  </div>
...
Output   →  Party Pᵢ holds secret share xᵢ = Σⱼ fⱼ(i) mod n
           ...
           sk = Σ xᵢ is NEVER assembled by any party`}
                ...
                <h3 className="text-lg font-bold text-[#f8fafc] mt-10 mb-4">Threshold Signing — The CMP Improvement</h3>
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                  The signing protocol in MPC-CMP achieves ECDSA threshold signing in <strong className="text-[#f8fafc]">4 rounds</strong> (reduced from earlier protocols requiring preprocessing). The key innovation is the use of Paillier encryption for the randomness multiplication step — the part of ECDSA generation that previously required either a trusted dealer or expensive zero-knowledge proofs.
                </p>
                ...
                <div className="bg-[#0a0a12] border border-[#1a1a2e] rounded-xl overflow-hidden my-8">
                  <div className="flex items-center gap-2 px-5 py-3 border-b border-[#1a1a2e] bg-[rgba(255,255,255,0.02)]">
                    ...
                    <span className="w-3 h-3 rounded-full bg-[#f59e0b]" />
                    <span className="w-3 h-3 rounded-full bg-[#10b981]" />
                    <span className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] ml-2">Protocol · MPC-CMP Signing — t-of-n Threshold Signing</span>
                  </div>
                  <pre className="p-5 text-[13px] leading-relaxed overflow-x-auto text-[#94a3b8] font-mono">
...
Output   →  Any party aggregates: σ = Σ σᵢ mod n
           ...
           No party's key share xᵢ was ever revealed`}
            ...
            <section id="hsm-integration">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">04 · Hardware</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                  MPC alone is a cryptographic protocol running on general-purpose compute. Without hardware roots of trust, the security boundary of each MPC node extends to the entire software stack — operating system, hypervisor, cloud provider infrastructure, and every library in the dependency chain. <strong className="text-[#f8fafc]">Hardware Security Modules (HSMs)</strong> establish a hardware-enforced boundary within which key material cannot be extracted regardless of software compromise.
                </p>

                <div className="bg-[#0a0a12] border border-[#1a1a2e] rounded-xl overflow-hidden my-8 p-6 font-mono text-[13px] leading-relaxed text-[#94a3b8]">
                  <span className="text-[10px] font-mono tracking-widest uppercase text-[#a855f7] block mb-4">// HSM-Anchored MPC Node Architecture</span>
                  <div className="text-center mb-2">
                    <span className="inline-block border border-[rgba(184,146,42,0.4)] px-4 py-2 text-[#d4e8f0]">Policy Engine / Transaction Authorisation</span>
                  </div>
                  <div className="text-center text-[rgba(184,146,42,0.6)] my-1">│</div>
                  <div className="text-center mb-2">
                    <span className="inline-block border border-[#1a1a2e] px-4 py-2 text-[#94a3b8]">MPC Protocol Runtime (userspace)</span>
                  </div>
                  <div className="text-center text-[rgba(184,146,42,0.6)] my-1">│  PKCS#11 / vendor API</div>
                  <div className="text-center mb-2">
                    <span className="inline-block border border-[rgba(184,146,42,0.4)] px-4 py-2 text-[#d4ab4a]">HSM Boundary</span>
                  </div>
                  <div className="text-center flex justify-center gap-2 mb-2">
                    <span className="inline-block border border-[#4a9a5a] px-3 py-1 text-[#7acc8a] text-[12px]">Key Share Storage</span>
                    <span className="inline-block border border-[#4a9a5a] px-3 py-1 text-[#7acc8a] text-[12px]">Crypto Engine</span>
                    <span className="inline-block border border-[#4a9a5a] px-3 py-1 text-[#7acc8a] text-[12px]">Attestation / RNG</span>
                  </div>
                  <div className="text-center text-[rgba(200,220,240,0.35)] text-[11px] mt-3">
                    FIPS 140-2 Level 3 / CC EAL4+ · Tamper-responsive enclosure · Zeroisation on attack
                  </div>
                </div>

                <h3 className="text-lg font-bold text-[#f8fafc] mt-10 mb-4">HSM Selection Criteria for MPC Nodes</h3>
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-10">
                  <div className="bg-[#0a0a12] border border-[#1a1a2e] rounded-xl p-6">
                    <h4 className="text-[10px] font-mono tracking-widest uppercase text-[#a855f7] mb-4">Required Capabilities</h4>
                    <ul className="space-y-3">
                      {[
                  ...
                  <div className="bg-[#0a0a12] border border-[#1a1a2e] rounded-xl p-6">
                    <h4 className="text-[10px] font-mono tracking-widest uppercase text-[#f59e0b] mb-4">Vendor Landscape</h4>
                    <ul className="space-y-3">
                      {[
                ...
                <div className="bg-[rgba(59,130,246,0.06)] border border-[rgba(59,130,246,0.15)] rounded-xl p-6 md:p-8">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#3b82f6] mb-3">The Cloud HSM Tradeoff</div>
                  <p className="text-sm text-[#94a3b8] leading-relaxed">
            ...
            <section id="key-ceremony">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">05 · Operations</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="my-10 border border-[#1a1a2e] rounded-xl overflow-hidden">
                  {[
                    ...
                    <div key={phase.num} className="grid grid-cols-[72px_1fr] sm:grid-cols-[72px_1fr] border-b border-[#1a1a2e] last:border-0">
                      <div className="bg-[#0f0524] flex items-center justify-center text-2xl italic text-[#a855f7] font-serif border-r border-[#1a1a2e]">
                        {phase.num}
                      </div>
                      <div className="p-6 bg-[#0a0a12]">
                        <h4 className="text-[10px] font-mono tracking-widest uppercase text-[#a855f7] mb-3">{phase.title}</h4>
                        <p className="text-[13px] text-[#94a3b8] leading-relaxed">{phase.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <section id="disaster-recovery">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">06 · Resilience</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="overflow-x-auto my-10">
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#1a1a2e]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#a855f7]">Scenario</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#a855f7]">Recovery Mechanism</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#a855f7]">RTO Target</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#a855f7]">Governance Required</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                ...
                <div className="bg-[rgba(59,130,246,0.06)] border border-[rgba(59,130,246,0.15)] rounded-xl p-6 md:p-8">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#3b82f6] mb-3">The Trustee Independence Problem</div>
                  <p className="text-sm text-[#94a3b8] leading-relaxed">
            ...
            <section id="fireblocks">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">07 · Case Study</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <h3 className="text-lg font-bold text-[#f8fafc] mt-10 mb-4">The MPC-CMP Implementation</h3>
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                  Fireblocks implements MPC-CMP with a <strong className="text-[#f8fafc]">2-of-3 default threshold scheme</strong>: one share held by the Fireblocks cloud infrastructure, one by the client's mobile device (protected by the device's secure enclave), and one in cold backup storage. This design creates a specific security model: any signing operation requires Fireblocks infrastructure cooperation, which is simultaneously its primary security guarantee and its primary regulatory concern.
                </p>

                <div className="bg-[#0a0a12] border border-[#1a1a2e] rounded-xl overflow-hidden my-8 p-6 font-mono text-[13px] leading-relaxed text-[#94a3b8]">
                  <span className="text-[10px] font-mono tracking-widest uppercase text-[#a855f7] block mb-4">// Fireblocks Three-Share Architecture (Simplified)</span>
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    <div className="text-center">
                      <span className="inline-block border border-[#1a1a2e] px-3 py-2 text-[#94a3b8] text-[12px] w-full">Fireblocks SGX Enclave<br/><span className="text-[rgba(200,220,240,0.4)] text-[11px]">Cloud · Always available<br/>Share [1 of 3]</span></span>
                    </div>
                    <div className="text-center">
                      <span className="inline-block border border-[rgba(184,146,42,0.4)] px-3 py-2 text-[#d4ab4a] text-[12px] w-full">Client Mobile / HSM<br/><span className="text-[rgba(184,146,42,0.6)] text-[11px]">iOS Secure Enclave<br/>Share [2 of 3]</span></span>
                    </div>
                    <div className="text-center">
                      <span className="inline-block border border-[#1a1a2e] px-3 py-2 text-[#94a3b8] text-[12px] w-full">Cold Backup Share<br/><span className="text-[rgba(200,220,240,0.4)] text-[11px]">Encrypted · Offline<br/>Share [3 of 3]</span></span>
                    </div>
                  </div>
                ...
                <h3 className="text-lg font-bold text-[#f8fafc] mt-10 mb-4">Intel SGX as Software HSM</h3>
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                  Fireblocks uses <strong className="text-[#f8fafc]">Intel SGX (Software Guard Extensions)</strong> as the hardware root of trust for its cloud-hosted key share, rather than traditional HSMs. SGX enclaves provide memory encryption and attestation — code running inside an enclave cannot be inspected by the host OS, hypervisor, or cloud provider. This is a pragmatic choice for a cloud-native architecture.
                </p>
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
            ...
            <section id="anchorage">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">08 · Case Study</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <h3 className="text-lg font-bold text-[#f8fafc] mt-10 mb-4">The Biometric-MPC Hybrid Model</h3>
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                  Anchorage's signature architectural innovation is the integration of <strong className="text-[#f8fafc]">biometric authentication directly into the MPC signing quorum</strong>. Rather than relying solely on device possession, Anchorage requires biometric verification (fingerprint or face) from designated human approvers, whose biometric data is stored in an on-device secure enclave and never transmitted to Anchorage's servers. The biometric verification unlocks the approver's key share for the duration of the signing session only.
                </p>
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                  This architecture satisfies a specific regulatory requirement: <strong className="text-[#f8fafc]">human intentionality in the signing process</strong>. A rogue automated system cannot satisfy the biometric threshold without physical human cooperation — directly addressing the coercion and rogue employee scenarios that concern banking regulators most acutely.
                </p>

                <h3 className="text-lg font-bold text-[#f8fafc] mt-10 mb-4">Physical Infrastructure and Regulatory Design</h3>
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                  As a nationally chartered bank, Anchorage's custody infrastructure is designed to satisfy <strong className="text-[#f8fafc]">OCC Handbook</strong> requirements for custodial services, <strong className="text-[#f8fafc]">NIST SP 800-57</strong> key management standards, and the examination expectations of federal bank examiners. This creates a design constraint that differs fundamentally from non-bank MPC vendors: every component must be documentable, examinable, and explainable to a non-technical regulatory audience.
                </p>
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
            ...
            <section id="governance">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">09 · Governance</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[rgba(124,58,237,0.06)] border border-[rgba(124,58,237,0.15)] rounded-xl p-6 md:p-8">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#a855f7] mb-3">Governance Layer Requirements Checklist</div>
                  <div className="space-y-3">
                    {[
                      ...
                      <p key={i} className="text-[13px] text-[#94a3b8] leading-relaxed flex items-start gap-3">
                        <span className="text-[#a855f7] font-mono text-[10px] mt-1 shrink-0">[{String(i + 1).padStart(2, "0")}]</span>
                        {item}
                      </p>
                    ))}
                  </div>
            ...
            <section id="recommendations">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">10 · Strategy</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                <div className="overflow-x-auto my-10">
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#1a1a2e]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#a855f7]">Firm Profile</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#a855f7]">Recommended Architecture</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#a855f7]">Key Considerations</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ...
                        <tr key={i} className="border-b border-[#1a1a2e]/60 hover:bg-[rgba(124,58,237,0.03)] transition-colors">
                          <td className="py-3 px-4 text-[#f8fafc] font-medium text-[13px] whitespace-pre-line">{row[0]}</td>
                          <td className="py-3 px-4 text-[#94a3b8]">{row[1]}</td>
                          <td className="py-3 px-4 text-[#94a3b8]">{row[2]}</td>
                        </tr>
                      ))}
