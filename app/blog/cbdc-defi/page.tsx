          ...
          <div className="space-y-24">
            ...
            <div className="space-y-6">
              <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                Two financial revolutions are unfolding simultaneously — and they are heading toward each other at speed. On one side, <strong className="text-[#201c14]">central bank digital currencies (CBDCs)</strong> represent the most ambitious reimagining of sovereign money since the abandonment of the gold standard. On the other, <strong className="text-[#201c14]">decentralized finance (DeFi)</strong> has constructed an entirely parallel financial system built on open-source code, cryptographic trust, and the radical proposition that intermediaries are unnecessary.
              </p>
              <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
            ...
            <section id="what-are-cbdcs">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">01 · Sovereign Money</div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  The distinction between <strong className="text-[#201c14]">retail CBDCs</strong> (available to the general public) and <strong className="text-[#201c14]">wholesale CBDCs</strong> (restricted to financial institutions for interbank settlement) is critical. Most public debate centres on retail CBDCs, which promise financial inclusion for the unbanked, frictionless cross-border payments, and — controversially — programmable money that can have conditions embedded into how it is spent.
                </p>

                {/* Info Box */}
                <div className="bg-[rgba(185,138,61,0.06)] border border-[rgba(185,138,61,0.15)] rounded-xl p-6 md:p-8">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#b98a3d] mb-3">Key Concept</div>
                  <h4 className="text-base font-bold text-[#201c14] mb-3">Programmable Money: The Double-Edged Feature</h4>
            ...
            <section id="what-is-defi">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">02 · Open Finance</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="my-10 pl-6 md:pl-8 border-l-[3px] border-[#c2703f] bg-[rgba(194,112,63,0.05)] rounded-r-lg p-6 md:p-8 relative">
                  ...
                  <cite className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] not-italic">— Conceptual framing, BIS Working Paper 2023</cite>
                </div>
            ...
            <section id="key-differences">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">03 · The Divide</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
                  CBDCs vs DeFi: Core Differences That Define the Divide
                </h2>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#ddd0b2] rounded-xl overflow-hidden my-10">
                <div className="bg-[#fbf7ee] p-6 text-center">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#201c14] bg-[#ddd0b2] inline-block px-4 py-2 rounded">CBDCs</div>
                </div>
                <div className="bg-[#fbf7ee] p-6 text-center">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#201c14] bg-[#c2703f] inline-block px-4 py-2 rounded">DeFi</div>
                </div>
                ...
                {[
                  ...
                  <div key={`${label}-l`} className="bg-[#fbf7ee] p-6">
                    <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-2">{label}</div>
                    <p className="text-sm text-[#5c5644] leading-relaxed">{cbdc}</p>
                  </div>,
                  <div key={`${label}-r`} className="bg-[#fbf7ee] p-6">
                    <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-2">{label}</div>
                    <p className="text-sm text-[#5c5644] leading-relaxed">{defi}</p>
                  </div>,
                ])}
              </div>
            </section>
            ...
            <section id="global-landscape">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">04 · Global Race</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-[#ddd0b2] rounded-xl overflow-hidden my-10">
                  {[
                    ...
                    <div key={stat.label} className="bg-[#fbf7ee] p-8 text-center">
                      ...
                      <span className="text-[13px] text-[#8a8268] leading-relaxed">{stat.label}</span>
                    </div>
                  ))}
                </div>
            ...
            <section id="threat-or-opportunity">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">05 · Analysis</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[rgba(147,170,184,0.06)] border border-[rgba(147,170,184,0.15)] rounded-xl p-6 md:p-8">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#93aab8] mb-3">Analyst Perspective</div>
                  <h4 className="text-base font-bold text-[#201c14] mb-3">Why CBDCs May Actually Accelerate DeFi Adoption</h4>
                  <p className="text-sm text-[#5c5644] leading-relaxed">
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  Equally, the DeFi sector's growing focus on <strong className="text-[#201c14]">real-world asset tokenization</strong> — tokenizing government bonds, mortgage-backed securities, and corporate debt — creates a natural surface for CBDC integration. If tokenized US Treasuries settle in digital dollars on a blockchain, the line between institutional DeFi and CBDC infrastructure becomes difficult to draw.
                </p>
              </div>
            </section>
            ...
            <section id="convergence-paths">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">06 · Scenarios</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.num} className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-xl p-6 md:p-8 flex gap-6">
                    <span className="text-4xl md:text-5xl font-extrabold text-[#ddd0b2] shrink-0 select-none leading-none">{item.num}</span>
                    <div>
            ...
            <section id="regulatory-pressure">
              ...
              <div className="space-y-6">
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  The critical battleground is the question of <strong className="text-[#201c14]">who counts as a regulated entity</strong> in a decentralised protocol. FATF guidance suggests that developers, governance token holders, or front-end interface operators may qualify as VASPs — virtual asset service providers — subject to KYC/AML obligations. If this interpretation prevails in major jurisdictions, it effectively forces DeFi protocols to choose: implement identity layers, restrict access by geography, or operate offshore.
                </p>

                {/* Pull Quote */}
                <div className="my-10 pl-6 md:pl-8 border-l-[3px] border-[#b0432f] bg-[rgba(176,67,47,0.05)] rounded-r-lg p-6 md:p-8 relative">
                  <div className="absolute top-2 left-4 text-6xl text-[#b0432f] opacity-20 font-serif leading-none">&ldquo;</div>
                  <p className="text-base md:text-lg italic text-[#b0432f] leading-relaxed relative z-10 mb-3">
                    Decentralisation is not a compliance exemption. It is a design parameter regulators are rapidly learning to work around.
                  </p>
                  <cite className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] not-italic">— Regulatory synthesis, 2024</cite>
                </div>
            ...
            <section id="future-scenarios">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#201c14] mb-3">Stablecoin Regulation as Proxy War</h3>
                  <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#201c14] mb-3">The DeFi Response: Real-World Assets and Institutional Channels</h3>
                  <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                    The DeFi sector's growth in <strong className="text-[#201c14]">real-world asset (RWA) tokenization</strong> — which has grown from near-zero to billions in TVL over 2023–2025 — demonstrates a deliberate strategic pivot toward institutional legitimacy. Protocols like Ondo Finance, Centrifuge, and Maple Finance are building bridges between traditional financial assets and DeFi liquidity. This pivot simultaneously makes DeFi more valuable to institutional participants and more legible to regulators — a calculated bet that compliance and openness are not mutually exclusive.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-2xl p-10 md:p-14">
              <div className="text-[10px] font-mono tracking-widest uppercase text-[#c2703f] mb-4">Final Analysis</div>
