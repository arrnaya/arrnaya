...
export default function CrossBorderPaymentsPage() {
  return (
    <>
      ...
      <Navbar />
      <main className="min-h-screen bg-[#f5efe2] text-[#201c14]">
        {/* ── Hero ─────────────────────────────────────────────── */}
        <section className="relative overflow-hidden bg-[#ece1cc] pt-24 pb-20">
          {/* Radial blur orbs */}
          ...
          <div
            ...
            style={{
              backgroundImage: `
                radial-gradient(circle at 10% 20%, rgba(194,112,63,0.15) 0%, transparent 50%),
                radial-gradient(circle at 90% 80%, rgba(147,170,184,0.1) 0%, transparent 50%),
                radial-gradient(circle at 50% 50%, rgba(194,112,63,0.05) 0%, transparent 70%)
              `,
            }}
          />

          <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#c2703f]/30 bg-[#c2703f]/10 px-4 py-1.5">
              <span className="text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">
                Payments & Financial Infrastructure
              </span>
            </div>
            <h1 className="font-display mt-4 text-3xl md:text-5xl font-bold leading-tight text-[#201c14]">
              Cross-Border Payments on Blockchain:<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-blue-400">
                Replacing Correspondent Banking
              </span>
            </h1>
            <p className="mt-6 text-lg text-[#5c5644] max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4 text-sm text-[#8a8268] font-mono">
        ...
        <div className="mx-auto max-w-4xl px-6 py-16 space-y-20">
          ...
          {/* Table of Contents */}
          <nav className="rounded-2xl border border-[#ddd0b2] bg-[#fbf7ee] p-6">
            <p className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">Table of Contents</p>
            <ol className="space-y-2">
              {tocItems.map((item, i) => (
                <li key={item.id} className="flex items-start gap-3">
                  <span className="text-[#c2703f] font-mono text-xs mt-0.5 w-5 shrink-0">{String(i + 1).padStart(2, "0")}</span>
                  <a href={`#${item.id}`} className="text-[#5c5644] hover:text-[#c2703f] text-sm transition-colors">
                    {item.label}
                  </a>
                </li>
              ))}
          ...
          <section id="problem">
            <p className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-2">Section 01</p>
            <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-6">The Correspondent Banking Problem</h2>

            <p className="text-[#5c5644] leading-relaxed mb-6">
            ...
            {/* Pull Quote */}
            <blockquote className="my-8 pl-6 border-l-4 border-[#c2703f]">
              <p className="text-lg italic text-[#201c14] leading-relaxed">
            ...
            <div className="rounded-xl border border-[#ddd0b2] overflow-hidden my-8">
              <div className="bg-[#fbf7ee] border-b border-[#ddd0b2] px-4 py-2">
                <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">Correspondent Chain: KL → São Paulo</span>
              </div>
              <table className="w-full text-[13px] border-collapse">
                <thead>
                  <tr className="border-b border-[#ddd0b2]">
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Hop</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Institution</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Action</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Fee</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Latency</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={hop} className="border-b border-[#ddd0b2] hover:bg-[rgba(194,112,63,0.03)] transition-colors">
                      <td className="px-4 py-3 text-[#c2703f] font-mono">{hop}</td>
                      <td className="px-4 py-3 text-[#201c14]">{inst}</td>
                      <td className="px-4 py-3 text-[#5c5644]">{action}</td>
                      <td className="px-4 py-3 text-[#b98a3d] font-mono">{fee}</td>
                      <td className="px-4 py-3 text-[#5c5644]">{lat}</td>
                    </tr>
                  ))}
                  <tr className="bg-[rgba(194,112,63,0.05)]">
                    <td className="px-4 py-3 text-[#8a8268] font-mono">—</td>
                    <td className="px-4 py-3 text-[#201c14] font-semibold">Total</td>
                    <td className="px-4 py-3 text-[#5c5644]">5 hops, 3 currency conversions</td>
                    <td className="px-4 py-3 text-[#b0432f] font-mono font-bold">$65–125</td>
                    <td className="px-4 py-3 text-[#b0432f] font-mono font-bold">2–4 days</td>
                  </tr>
                </tbody>
              </table>
            </div>

            <p className="text-[#5c5644] leading-relaxed">
          ...
          <section id="mechanics">
            <p className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-2">Section 02</p>
            <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-6">Blockchain Payment Mechanics</h2>
            ...
            <div className="rounded-xl border border-[#ddd0b2] overflow-hidden my-8">
              <div className="bg-[#fbf7ee] border-b border-[#ddd0b2] px-4 py-2 flex items-center justify-between">
                <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">Payment Flow: Blockchain Rail</span>
                <span className="text-[10px] font-mono text-[#c2703f]">KL → São Paulo</span>
              </div>
              <pre className="bg-[#f5efe2] text-[#5c5644] text-[12px] p-5 overflow-x-auto leading-relaxed font-mono">
...
Settlement finality: cryptographic (vs probabilistic reconciliation)`}
            ...
            <div className="rounded-xl border border-[#ddd0b2] overflow-hidden my-8">
              <div className="bg-[#fbf7ee] border-b border-[#ddd0b2] px-4 py-2">
                <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">Settlement Model Comparison</span>
              </div>
              <table className="w-full text-[13px] border-collapse">
                <thead>
                  <tr className="border-b border-[#ddd0b2]">
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Property</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Correspondent Banking</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Blockchain Rail</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={prop} className="border-b border-[#ddd0b2] hover:bg-[rgba(194,112,63,0.03)] transition-colors">
                      <td className="px-4 py-3 text-[#201c14] font-medium">{prop}</td>
                      <td className="px-4 py-3 text-[#b0432f]/80">{trad}</td>
                      <td className="px-4 py-3 text-[#74805e]">{chain}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <section id="stablecoin-rails">
            <p className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-2">Section 03</p>
            <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-6">Stablecoin Rails: Architecture Choices</h2>
            ...
            <div className="rounded-xl border border-[#ddd0b2] overflow-hidden my-8">
              <div className="bg-[#fbf7ee] border-b border-[#ddd0b2] px-4 py-2">
                <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">Chain Selection Matrix for Payment Rails</span>
              </div>
              <table className="w-full text-[13px] border-collapse">
                <thead>
                  <tr className="border-b border-[#ddd0b2]">
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Chain</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">TPS</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Finality</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Gas Cost</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">USDC Support</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Best For</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={chain} className="border-b border-[#ddd0b2] hover:bg-[rgba(194,112,63,0.03)] transition-colors">
                      <td className="px-4 py-3 text-[#c2703f] font-mono font-medium">{chain}</td>
                      <td className="px-4 py-3 text-[#201c14] font-mono">{tps}</td>
                      <td className="px-4 py-3 text-[#74805e] font-mono">{fin}</td>
                      <td className="px-4 py-3 text-[#b98a3d] font-mono">{gas}</td>
                      <td className="px-4 py-3 text-[#5c5644]">{usdc}</td>
                      <td className="px-4 py-3 text-[#5c5644] text-xs">{best}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          {/* Section 4: CCTP */}
          <section id="cctp">
            <p className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-2">Section 04</p>
            <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-6">Cross-Chain Transfer Protocols</h2>
            ...
            <div className="rounded-xl border border-[#ddd0b2] overflow-hidden my-8">
              <div className="bg-[#fbf7ee] border-b border-[#ddd0b2] px-4 py-2 flex items-center justify-between">
                <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">Circle CCTP: Burn-and-Mint Protocol</span>
                <span className="text-[10px] font-mono text-[#74805e]">v2 · 2024</span>
              </div>
              <pre className="bg-[#f5efe2] text-[#5c5644] text-[12px] p-5 overflow-x-auto leading-relaxed font-mono">
...
Key property: No bridge liquidity pool. No wrapped tokens.
          ...
          <section id="liquidity">
            <p className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-2">Section 05</p>
            <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-6">Liquidity Provisioning Design</h2>
            ...
            <div className="rounded-xl border border-[#ddd0b2] overflow-hidden my-8">
              <div className="bg-[#fbf7ee] border-b border-[#ddd0b2] px-4 py-2">
                <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">Liquidity Inventory Model</span>
              </div>
              <pre className="bg-[#f5efe2] text-[#5c5644] text-[12px] p-5 overflow-x-auto leading-relaxed font-mono">
...
Optimization: Pool inventory across corridors
  ...
  by 40–70% depending on corridor correlation.`}
          ...
          <section id="compliance">
            <p className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-2">Section 06</p>
            <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-6">Regulatory & Compliance Stack</h2>
            ...
            <div className="space-y-4 my-8">
              {[
                ...
                <div key={item.num} className="flex gap-4 p-5 rounded-xl border border-[#ddd0b2] bg-[#fbf7ee]">
                  <div className="shrink-0 w-10 h-10 rounded-full border border-[#c2703f]/50 flex items-center justify-center">
                    <span className="text-[11px] font-mono text-[#c2703f]">{item.num}</span>
                  </div>
                  <div>
                    <h3 className="text-[#201c14] font-semibold mb-1">{item.title}</h3>
                    <p className="text-[#5c5644] text-sm leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section id="corridors">
            <p className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-2">Section 07</p>
            <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-6">Live Corridor Analysis</h2>
            ...
            <div className="rounded-xl border border-[#ddd0b2] overflow-hidden my-8">
              <div className="bg-[#fbf7ee] border-b border-[#ddd0b2] px-4 py-2">
                <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">High-Viability Corridors for Blockchain Rails (2026)</span>
              </div>
              <table className="w-full text-[13px] border-collapse">
                <thead>
                  <tr className="border-b border-[#ddd0b2]">
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Corridor</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Annual Volume</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Trad. Cost</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Chain Cost</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Active Players</th>
                    <th className="text-left px-4 py-3 text-[#8a8268] font-mono text-xs uppercase">Readiness</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={corridor} className="border-b border-[#ddd0b2] hover:bg-[rgba(194,112,63,0.03)] transition-colors">
                      <td className="px-4 py-3 text-[#201c14] font-medium">{corridor}</td>
                      <td className="px-4 py-3 text-[#5c5644] font-mono">{vol}</td>
                      <td className="px-4 py-3 text-[#b0432f] font-mono">{trad}</td>
                      <td className="px-4 py-3 text-[#74805e] font-mono">{chain}</td>
                      <td className="px-4 py-3 text-[#5c5644] text-xs">{players}</td>
            ...
            <blockquote className="my-8 pl-6 border-l-4 border-[#93aab8]">
              <p className="text-lg italic text-[#201c14] leading-relaxed">
          ...
          <section id="failure-modes">
            <p className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-2">Section 08</p>
            <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-6">Failure Modes & Risk Vectors</h2>
            ...
            <div className="grid md:grid-cols-2 gap-4 my-8">
              {[
                ...
                <div key={risk.title} className={`p-5 rounded-xl border ${risk.color}`}>
                  ...
                  <h3 className="text-[#201c14] font-semibold mb-2">{risk.title}</h3>
                  <p className="text-[#5c5644] text-sm leading-relaxed">{risk.desc}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section id="deployment">
            <p className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-2">Section 09</p>
            <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-6">Deployment Architecture</h2>
            ...
            <div className="rounded-xl border border-[#ddd0b2] overflow-hidden my-8">
              <div className="bg-[#fbf7ee] border-b border-[#ddd0b2] px-4 py-2 flex items-center justify-between">
                <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268]">Reference Architecture: Production Payment Rail</span>
                <span className="text-[10px] font-mono text-[#c2703f]">v1.0</span>
              </div>
              <pre className="bg-[#f5efe2] text-[#5c5644] text-[12px] p-5 overflow-x-auto leading-relaxed font-mono">
{`┌─────────────────────────────────────────────────────────────────┐
...
└─────────────────────────────────────────────────────────────────┘`}
          ...
          <section id="faq">
            ...
            <div className="space-y-3">
              {[
                ...
                <details key={i} className="group rounded-xl border border-[#ddd0b2] bg-[#fbf7ee] overflow-hidden">
                  <summary className="flex items-center justify-between px-5 py-4 cursor-pointer list-none">
                    <span className="text-[#201c14] font-medium text-sm pr-4">{item.q}</span>
                    <span className="text-[#c2703f] shrink-0 text-lg group-open:rotate-45 transition-transform">+</span>
                  </summary>
                  <div className="px-5 pb-4 text-[#5c5644] text-sm leading-relaxed border-t border-[#ddd0b2] pt-4">
                    {item.a}
                  </div>
                </details>
              ))}
          ...
          {/* Conclusion */}
          <section>
            <div className="rounded-2xl border border-[#ddd0b2] bg-[#fbf7ee] p-8 text-center">
              <div className="text-3xl mb-4">◈</div>
              <h2 className="font-display text-xl md:text-2xl font-bold text-[#201c14] mb-4">
                The Correspondent Bank Is Being Disintermediated
              </h2>
              <p className="text-[#5c5644] leading-relaxed max-w-2xl mx-auto mb-6">
              ...
              <p className="text-[#8a8268] text-sm font-mono">
          ...
          {/* Related Reading */}
          <section>
            <p className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-4">Related Reading</p>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <a key={post.url} href={post.url} className="block p-5 rounded-xl border border-[#ddd0b2] bg-[#fbf7ee] hover:border-[#c2703f]/40 transition-colors group">
                  <h3 className="text-[#201c14] font-medium mb-2 group-hover:text-[#c2703f] transition-colors text-sm">{post.title}</h3>
                  <p className="text-[#8a8268] text-xs leading-relaxed">{post.desc}</p>
                </a>
              ))}
            </div>
          </section>
        ...
        {/* Post Footer */}
        <div className="border-t border-[#ddd0b2] py-8">
          <div className="mx-auto max-w-4xl px-6 flex flex-wrap items-center justify-between gap-4 text-[#8a8268] font-mono text-xs">
