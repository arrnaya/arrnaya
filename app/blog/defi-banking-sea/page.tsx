        ...
        <header className="relative py-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-28 md:py-36">
            <div className="flex flex-wrap items-center gap-3 mb-10">
              ...
              <span className="text-[11px] text-[#5c5644]">14 min read</span>
            </div>
          ...
          <div className="space-y-24">
            ...
            <section id="problem">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">01 · The Crisis</div>
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  Across the eleven nations of Southeast Asia — home to over 680 million people and some of the world&apos;s fastest-growing economies — a persistent and painful paradox endures. While Singapore hosts global wealth management giants and Bangkok&apos;s startup scene rivals Silicon Valley, an estimated <strong className="text-[#201c14]">290 million adults across the region remain completely unbanked</strong>. Hundreds of millions more are classified as &quot;underbanked&quot; — holding a basic account but unable to access credit, insurance, investment vehicles, or cross-border transfers at fair rates.
                </p>
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 my-10">
                  {[
                    { num: "51%", label: "Unbanked adults in the Philippines", color: "#93aab8" },
                    { num: "48%", label: "Unbanked adults in Indonesia", color: "#b98a3d" },
                    { num: "65%", label: "Rural unbanked in Cambodia", color: "#74805e" },
                    { num: "$30B+", label: "Annual remittance fees paid by SEA migrants", color: "#c2703f" },
                  ].map((stat) => (
                    <div key={stat.label} className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-xl p-6 relative overflow-hidden">
                      ...
                      <div className="text-[11px] text-[#8a8268] leading-relaxed">{stat.label}</div>
                    </div>
                  ))}
                </div>
            ...
            <section id="why-defi">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">02 · The Alternative</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                {/* Pull Quote */}
                <div className="my-10 pl-6 md:pl-8 border-l-[3px] border-[#93aab8] bg-[rgba(147,170,184,0.05)] rounded-r-lg p-6 md:p-8 relative">
                  <div className="absolute top-2 left-4 text-6xl text-[#93aab8] opacity-20 font-serif leading-none">&ldquo;</div>
                  <p className="text-base md:text-lg italic text-[#93aab8] leading-relaxed relative z-10 mb-3">
                  ...
                  <cite className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] not-italic">— The Core DeFi Proposition</cite>
                </div>
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  For Southeast Asia specifically, this architecture has three killer advantages: <strong className="text-[#201c14]">permissionless access</strong> that requires nothing more than a smartphone and internet connection; <strong className="text-[#201c14]">interoperability</strong> that allows borderless value transfer at near-zero cost; and <strong className="text-[#201c14]">programmability</strong> that enables financial products tailored to the realities of informal economies — daily wage earners, seasonal farmers, gig workers, and market traders — without requiring expensive human underwriters.
                </p>

                <h3 className="text-lg font-bold text-[#201c14] mt-10 mb-4">The Smartphone Leapfrog: SEA&apos;s Unique Opportunity</h3>
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
            ...
            <section id="landscape">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">03 · The Landscape</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
                  ...
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#ddd0b2]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">Country</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">Unbanked Rate</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">Crypto Adoption</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">Regulatory Stance</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">Key DeFi Driver</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
            ...
            <section id="use-cases">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">04 · Use Cases</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
            ...
            <section id="protocols">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">05 · Protocols</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={protocol.name} className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-xl p-6 hover:border-[#c7b790] transition-colors">
                    <div className="text-sm font-bold text-[#201c14] mb-1">{protocol.name}</div>
                    <div className="text-[10px] font-mono tracking-wider uppercase text-[#93aab8] mb-3">{protocol.chain}</div>
                    <p className="text-[13px] text-[#8a8268] leading-relaxed">{protocol.desc}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section id="barriers">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">06 · Barriers</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-[rgba(116,128,94,0.06)] border border-[rgba(116,128,94,0.15)] rounded-xl p-6 md:p-8">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#74805e] mb-3">Emerging Solution</div>
                  <p className="text-sm text-[#5c5644] leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#201c14] mb-3">Smart Contract Risk</h3>
                  <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#201c14] mb-3">Stablecoin Fragility</h3>
                  <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
            ...
            <section id="regulation">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">07 · Regulation</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#201c14] mb-3">Singapore (MAS): The Institutional Anchor</h3>
                  <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#201c14] mb-3">Philippines (BSP): A Progressive Pioneer</h3>
                  <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#201c14] mb-3">Indonesia (OJK/BI): Cautious Evolution</h3>
                  <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
            ...
            <section id="future">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">08 · The Future</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-0">
                  {[
                    ...
                    <div key={item.num} className="flex gap-4 py-5 border-b border-[#ddd0b2]/60">
                      <span className="text-xl font-extrabold text-[#c2703f] shrink-0 mt-0.5">{item.num}</span>
                      <div>
                ...
                <div className="my-10 pl-6 md:pl-8 border-l-[3px] border-[#c2703f] bg-[rgba(194,112,63,0.05)] rounded-r-lg p-6 md:p-8 relative">
                  ...
                  <cite className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] not-italic">— The Defining Challenge of the Decade</cite>
                </div>
              </div>
            </section>
            ...
            <section className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-2xl p-10 md:p-14 text-center">
              ...
              <p className="text-sm text-[#5c5644] leading-relaxed max-w-[1200px] mx-auto mb-6">
              ...
              <p className="text-sm text-[#5c5644] leading-relaxed max-w-[1200px] mx-auto mb-8">
