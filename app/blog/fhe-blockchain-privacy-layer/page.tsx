        ...
        <div className="max-w-[1200px] mx-auto px-6 py-24 md:py-32">
          <div className="space-y-24">
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm md:text-base text-[var(--text-muted)] leading-relaxed">
                Fully Homomorphic Encryption (FHE) is the first cryptographic primitive that removes the tradeoff entirely: a smart contract, or a network of nodes, can perform arbitrary computation directly on encrypted data and produce an encrypted result — without any party ever holding the plaintext. Proposed as theoretically possible by Craig Gentry in 2009, it spent over a decade as a fascinating but computationally impractical idea. That changed in the last twelve months. <a href="https://www.zama.ai/" target="_blank" rel="noopener noreferrer" className={linkCls}>Zama</a> shipped the first production FHE mainnet on Ethereum on December 30, 2025, and within its first weeks it had shielded more than $121 million in confidential USDT transfers. <a href="https://www.fhenix.io/" target="_blank" rel="noopener noreferrer" className={linkCls}>Fhenix</a> deployed a working FHE coprocessor on Arbitrum. <a href="https://www.inco.org/" target="_blank" rel="noopener noreferrer" className={linkCls}>Inco Network</a> launched a confidentiality layer that other chains can plug into directly.
              </p>
              <p className="text-sm md:text-base text-[var(--text-muted)] leading-relaxed">
            ...
            <section id="what-is-fhe">
              ...
              <div className="space-y-6">
                ...
                <p className="text-sm md:text-base text-[var(--text-muted)] leading-relaxed">
                  <a href="https://openfhe.org/" target="_blank" rel="noopener noreferrer" className={linkCls}>OpenFHE</a>, now at version 1.5.1, is the leading open-source library implementing all four scheme families with interoperability between them. On the production side, <a href="https://www.zama.ai/" target="_blank" rel="noopener noreferrer" className={linkCls}>Zama</a>&apos;s TFHE-rs and Concrete stack — the engine behind its fhEVM and Concrete ML — leads commercial deployment specifically for blockchain and machine-learning workloads. Neither replaces the other; they serve different points on the research-to-production spectrum.
                </p>
