    ...
    <>
      ...
      <article className="pt-20">
        ...
        <header className="relative py-20 overflow-hidden">
          ...
          <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-[#10b981] opacity-15 blur-[100px]" />
          ...
          <div
            ...
            style={{
              backgroundImage: `radial-gradient(circle at 20% 30%, rgba(168,85,247,0.4) 0px, rgba(168,85,247,0.4) 1px, transparent 1px),
                                radial-gradient(circle at 70% 20%, rgba(16,185,129,0.3) 0px, rgba(16,185,129,0.3) 1.5px, transparent 1.5px),
                                ...
                                radial-gradient(circle at 60% 50%, rgba(16,185,129,0.2) 0px, rgba(16,185,129,0.2) 2px, transparent 2px),
          ...
          <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-28 md:py-36">
            <div className="flex flex-wrap items-center gap-3 mb-10">
              <span className="text-[11px] font-semibold tracking-wider uppercase px-4 py-2 rounded-full bg-[rgba(16,185,129,0.15)] text-[#10b981] border border-[rgba(16,185,129,0.25)] backdrop-blur-sm">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-8">
              ...
              <span className="bg-gradient-to-r from-[#a855f7] to-[#10b981] bg-clip-text text-transparent">
                by 2036&rdquo;
              </span>
              <br />
            ...
            <ol className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              {toc.map((item, i) => (
                <li key={item.id}>
                  <a
                    href={`#${item.id}`}
                    className="text-sm text-[#94a3b8] hover:text-[#10b981] transition-colors leading-relaxed flex items-start gap-3"
                  >
        ...
        <div className="max-w-[1200px] mx-auto px-6 py-24 md:py-32">
          <div className="space-y-24">
              ...
              <div className="space-y-6">
                ...
                <p className="text-sm md:text-base text-[#94a3b8] leading-relaxed">
                  ...
                  <a
                    ...
                    className="text-[#10b981] underline underline-offset-4 hover:text-[#34d399] transition-colors"
                  >
                ...
                {/* YouTube Embed */}
                <div className="my-10 rounded-xl overflow-hidden border border-[#1a1a2e] bg-[#0a0a12]">
                  <div className="flex items-center justify-between px-5 py-3 border-b border-[#1a1a2e] bg-[rgba(255,255,255,0.02)]">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[10px] font-mono tracking-widest uppercase text-[#10b981] hover:text-[#34d399] transition-colors"
                    >
                      Open on YouTube ↗
                    </a>
                  </div>
                  ...
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#1a1a2e]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">#</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">Claim</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">Verdict</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ["1", "AI exceeds human intelligence within five years", "Plausible, definition-dependent", "#f59e0b"],
                        ["2", "AI plus robots produce unprecedented abundance", "Directionally credible on supply", "#f59e0b"],
                        ["3", "AI drives deflation, not inflation", "Partially credible — sector-selective", "#f59e0b"],
                        ["4", "Universal high income replaces work", "Unfalsifiable as stated", "#ef4444"],
                        ["5", "AI labs can peer-review each other on safety", "Structurally conflicted", "#ef4444"],
                        ["6", "Money won't matter by 2036", "Speculative — confuses the ledger with the scarcity", "#ef4444"],
                      ].map((row) => (
                        <tr key={row[0]} className="border-b border-[#1a1a2e]/60 hover:bg-[rgba(16,185,129,0.03)] transition-colors">
                          <td className="py-3 px-4 text-[#64748b] font-mono text-[12px]">{row[0]}</td>
                          <td className="py-3 px-4 text-[#f8fafc] font-medium">{row[1]}</td>
            ...
            <section id="deflation-engine">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">02 · Credit</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#0a0a12] border border-[#1a1a2e] rounded-xl overflow-hidden my-8">
                  <div className="flex items-center justify-between px-5 py-3 border-b border-[#1a1a2e] bg-[rgba(255,255,255,0.02)]">
                    <span className="text-[10px] font-mono tracking-widest uppercase text-[#64748b]">The Marginal Cost Argument, Formalized</span>
                  </div>
...
THIS IS THE PART OF THE THESIS THAT WORKS.`}
                ...
                <div className="bg-[rgba(16,185,129,0.06)] border border-[rgba(16,185,129,0.15)] rounded-xl p-6 md:p-8">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#10b981] mb-3">Key Insight</div>
            ...
            <section id="baumol-wall">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">03 · Fracture</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="overflow-x-auto my-10">
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#1a1a2e]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">Sector</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">AI Deflation Exposure</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">Binding Scarcity</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">2036 Price Outlook</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ["Software & content", "Near-total", "None — marginal cost already ≈ 0", "Deflates toward zero", "#10b981"],
                        ["Manufacturing & logistics", "High", "Energy, raw materials", "Strong deflation", "#10b981"],
                        ["Professional services", "High", "Liability, licensure, trust", "Deflation with friction", "#10b981"],
                        ["Energy", "Moderate", "Grid capacity, land, permitting", "Falls, bounded by buildout", "#f59e0b"],
                        ["Healthcare", "Partial", "Regulation, trust labor, liability", "Selective deflation at best", "#f59e0b"],
                        ["Education", "Partial", "Credentialing cartel, care labor", "Content free; degrees not", "#f59e0b"],
                        ["Housing", "Low", "Land, zoning, location", "No deflation without policy change", "#ef4444"],
                        ["Elder & child care", "Low", "Human presence is the product", "Baumol effect in full force", "#ef4444"],
                      ].map((row, i) => (
                        <tr key={i} className="border-b border-[#1a1a2e]/60 hover:bg-[rgba(16,185,129,0.03)] transition-colors">
                          <td className="py-3 px-4 text-[#f8fafc] font-medium">{row[0]}</td>
            ...
            <section id="distribution">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">04 · Distribution</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                {/* Pull Quote */}
                <div className="my-10 pl-6 md:pl-8 border-l-[3px] border-[#10b981] bg-[rgba(16,185,129,0.05)] rounded-r-lg p-6 md:p-8 relative">
                  <div className="absolute top-2 left-4 text-6xl text-[#10b981] opacity-20 font-serif leading-none">&ldquo;</div>
                  <p className="text-base md:text-lg italic text-[#10b981] leading-relaxed relative z-10 mb-3">
                  ...
                  <cite className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] not-italic">— On Engels&rsquo; Pause</cite>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="overflow-x-auto my-10">
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#1a1a2e]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">Design Parameter</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">UBI (as studied)</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">UHI (as stated)</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
            ...
            <section id="what-money-is">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">06 · First Principles</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#0a0a12] border border-[#1a1a2e] rounded-xl overflow-hidden my-8">
                  <div className="flex items-center justify-between px-5 py-3 border-b border-[#1a1a2e] bg-[rgba(255,255,255,0.02)]">
                    <span className="text-[10px] font-mono tracking-widest uppercase text-[#64748b]">Preconditions for a Post-Money Economy</span>
                  </div>
                  <pre className="p-5 text-[13px] leading-relaxed overflow-x-auto text-[#94a3b8]">
  ...
  Status check, 2026:
    ...
    #6 frontier still rationed`}
                ...
                <div className="my-10 pl-6 md:pl-8 border-l-[3px] border-[#a855f7] bg-[rgba(168,85,247,0.05)] rounded-r-lg p-6 md:p-8 relative">
                  ...
                  <cite className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] not-italic">— On the 2036 Claim</cite>
                </div>
            ...
            <section id="credibility-ledger">
              <div className="mb-10 pb-6 border-b border-[#1a1a2e]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#64748b] mb-3">07 · Calibration</div>
                <h2 className="text-xl md:text-[26px] font-bold text-[#f8fafc] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="overflow-x-auto my-10">
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#1a1a2e]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">Prediction</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">Made</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">Deadline</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#10b981]">Outcome</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ["Coast-to-coast autonomous demo drive", "2016", "End of 2017", "Missed — never performed", "#ef4444"],
                        ["One million robotaxis on the road", "2019", "2020", "Missed — limited geofenced pilots years later", "#ef4444"],
                        ["Level 5 autonomy \"this year\"", "2020", "2020", "Missed — driver supervision still required", "#ef4444"],
                        ["Cybertruck volume production", "2019", "2021", "First deliveries late 2023, slow ramp", "#f59e0b"],
                        ["Uncrewed Mars cargo mission", "2017", "2022", "Not attempted", "#ef4444"],
                        ["Orbital rocket reusability", "2011–2015", "—", "Delivered — now industry standard", "#10b981"],
                        ["Global LEO broadband at scale", "2015", "—", "Delivered — Starlink operational", "#10b981"],
                      ].map((row, i) => (
                        <tr key={i} className="border-b border-[#1a1a2e]/60 hover:bg-[rgba(16,185,129,0.03)] transition-colors">
                          <td className="py-3 px-4 text-[#f8fafc] font-medium">{row[0]}</td>
                          <td className="py-3 px-4 text-[#94a3b8]">{row[1]}</td>
            ...
            <section id="conclusion" className="bg-[#0a0a12] border border-[#1a1a2e] rounded-2xl p-10 md:p-14 text-center">
              <div className="text-[10px] font-mono tracking-widest uppercase text-[#10b981] mb-4">Synthesis</div>
