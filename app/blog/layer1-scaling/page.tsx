        ...
        <header className="relative py-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-28 md:py-36">
            <div className="flex flex-wrap items-center gap-3 mb-10">
              ...
              <span className="text-[11px] text-[#5c5644]">20 min read</span>
            </div>
          ...
          <div className="space-y-24">
            ...
            <div className="space-y-6">
              <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                The blockchain marketing playbook has a favourite number: <strong className="text-[#201c14]">transactions per second</strong>. Solana claims 65,000. Sui claims 297,000. Aptos claims 160,000. Every new Layer-1 emerges with a TPS figure designed to embarrass its predecessors — and every figure, examined closely, dissolves under a single question: <em>measured how, under what conditions, doing what?</em>
              </p>
              <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
            ...
            <section id="tps-problem">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">01 · Throughput</div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-xl overflow-hidden my-8">
                  <div className="flex items-center gap-2 px-5 py-3 border-b border-[#ddd0b2] bg-[rgba(32,28,20,0.02)]">
                    ...
                    <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] ml-2">benchmark_audit.sh — TPS Claim Deconstruction</span>
                  </div>
...
⚠  smart_contract_tps ≈ benchmark_tps × 0.005 to 0.04`}
            ...
            <section id="finality">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">02 · Latency</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  For most end-user experiences — and for virtually all cross-chain bridges, exchanges, and payments infrastructure — the relevant question is not how many transactions per second a chain can process, but <strong className="text-[#201c14]">how long after submission a transaction is irreversible</strong>. This is finality: the moment at which a transaction cannot be reorganised away by a future chain state.
                </p>
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-10">
                  {[
                    ...
                    <div key={item.num} className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-xl p-6">
                      <span className="text-[10px] font-mono tracking-widest uppercase text-[#c2703f] block mb-3">{item.num}</span>
                      <h4 className="text-base font-bold text-[#201c14] mb-3">{item.title}</h4>
                      <p className="text-[13px] text-[#5c5644] leading-relaxed">{item.desc}</p>
                    </div>
                  ))}
                </div>

                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  For payment applications, instant BFT finality is the gold standard. For DeFi protocols where liveness is paramount, economic finality with strong validator economics may be preferable. For store-of-value use cases, probabilistic finality backed by extreme hash rate remains the battle-tested choice. <strong className="text-[#201c14]">No single finality model is universally superior</strong> — but TPS tells you nothing about which model a chain uses.
                </p>
                ...
                <div className="my-10 pl-6 md:pl-8 border-l-[3px] border-[#c2703f] bg-[rgba(194,112,63,0.05)] rounded-r-lg p-6 md:p-8 relative">
                  ...
                  <cite className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] not-italic">— Infrastructure design principle</cite>
                </div>
              </div>
            </section>
            ...
            <section id="decentralization">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">03 · Decentralization</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                {/* Metric Grid */}
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-[#ddd0b2] rounded-xl overflow-hidden my-10">
                  {[
                    ...
                    <div key={stat.label} className="bg-[#fbf7ee] p-8 text-center">
                      <span className="text-4xl font-extrabold text-[#c2703f] block mb-2">{stat.num}</span>
                      <span className="text-[13px] text-[#5c5644] leading-relaxed block">{stat.label}</span>
                      <span className="text-[10px] text-[#8a8268] mt-2 block">{stat.sub}</span>
                    </div>
                  ))}
                </div>

                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  Node count is an imprecise but instructive proxy. A chain with 10,000 full nodes is meaningfully more decentralized than one with 100 — because geographic distribution, client diversity, and hardware accessibility compound. Ethereum's ~10,000 full nodes, distributed across dozens of countries and multiple client implementations (<strong className="text-[#201c14]">Geth, Lighthouse, Besu, Nethermind</strong>), represent a kind of decentralization that is structurally resistant to nation-state-level attack in ways that a 1,000-validator proof-of-stake chain operating within a handful of jurisdictions is not.
                </p>

                <h3 className="text-lg font-bold text-[#201c14] mt-10 mb-4">The Nakamoto Coefficient</h3>
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
            ...
            <section id="state-growth">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">04 · State Scalability</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-xl overflow-hidden my-8">
                  <div className="flex items-center gap-2 px-5 py-3 border-b border-[#ddd0b2] bg-[rgba(32,28,20,0.02)]">
                    ...
                    <span className="w-3 h-3 rounded-full bg-[#b98a3d]" />
                    <span className="w-3 h-3 rounded-full bg-[#74805e]" />
                    <span className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] ml-2">state_growth_analysis.rs</span>
                  </div>
                  <pre className="p-5 text-[13px] leading-relaxed overflow-x-auto text-[#5c5644] font-mono">
...
// Decentralization shrinks. The trilemma bites.`}
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  Solutions under active development — Ethereum's <strong className="text-[#201c14]">EIP-4444</strong> (history expiry), <strong className="text-[#201c14]">stateless clients</strong>, and <strong className="text-[#201c14]">Verkle trees</strong> — address this at the protocol level by separating history storage from state execution. These represent genuine progress. They also illustrate that TPS without a state growth management strategy is not a long-term scalability solution. It is a debt instrument: borrowed performance, payable in future centralization.
                </p>
              </div>
            </section>
            ...
            <section id="mev">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">05 · MEV</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[rgba(185,138,61,0.06)] border border-[rgba(185,138,61,0.15)] rounded-xl p-6 md:p-8">
                  <div className="text-[10px] font-mono tracking-widest uppercase text-[#b98a3d] mb-3">MEV Is Not a Bug. It Is a Revenue Model.</div>
                  <p className="text-sm text-[#5c5644] leading-relaxed">
            ...
            <section id="economic-security">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">06 · Security</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
                  ...
                  <table className="w-full text-[13px] border-collapse">
                    <thead>
                      <tr className="border-b border-[#ddd0b2]">
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">Chain</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">Consensus</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">Attack Cost (est.)</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">TPS (Real-world)</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">Finality</th>
                        <th className="text-left py-3 px-4 text-[10px] font-mono tracking-widest uppercase text-[#c2703f]">Nakamoto Coeff.</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
            ...
            <section id="real-framework">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">07 · Framework</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 my-10">
                  {[
                    ...
                    <div key={item.num} className="bg-[#fbf7ee] border border-[#ddd0b2] rounded-xl p-6">
                      <span className="text-[10px] font-mono tracking-widest uppercase text-[#c2703f] block mb-2">{item.num} {item.label}</span>
                      <h4 className="text-base font-bold text-[#201c14] mb-3">{item.title}</h4>
                      <p className="text-[13px] text-[#5c5644] leading-relaxed">{item.desc}</p>
                    </div>
                  ))}
            ...
            <section id="verdict">
              <div className="mb-10 pb-6 border-b border-[#ddd0b2]">
                <div className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] mb-3">08 · Verdict</div>
                <h2 className="font-display text-xl md:text-[26px] font-bold text-[#201c14] mb-4 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  <strong className="text-[#201c14]">For maximum security and decentralization:</strong> Ethereum remains the only chain with a combination of economic security, validator diversity, client pluralism, and geographic distribution that approaches meaningful censorship resistance at nation-state scale. Its throughput limitations are real, but its Layer-2 ecosystem (Arbitrum, Optimism, Base, zkSync) means that application throughput and Ethereum security are no longer mutually exclusive.
                </p>

                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  <strong className="text-[#201c14]">For applications requiring fast finality and high application-layer throughput:</strong> Solana's engineering is genuinely impressive, and its real-world performance in consumer applications (compressed NFTs, high-frequency trading, consumer payments) is unmatched among decentralised alternatives. The validator concentration and hardware requirements represent known, quantifiable tradeoffs — the question is whether they are acceptable for the specific application.
                </p>

                <p className="text-sm md:text-base text-[#5c5644] leading-relaxed">
                  <strong className="text-[#201c14]">For sovereign application chains:</strong> The Cosmos ecosystem's application-specific chain model — where each application runs its own BFT chain with its own validator set and token economics — offers a different kind of scalability: not more TPS on a shared chain, but the ability to design the chain itself around application requirements. The tradeoffs are security fragmentation and bridge complexity.
                </p>
                ...
                <div className="my-10 pl-6 md:pl-8 border-l-[3px] border-[#c2703f] bg-[rgba(194,112,63,0.05)] rounded-r-lg p-6 md:p-8 relative">
                  ...
                  <cite className="text-[10px] font-mono tracking-widest uppercase text-[#8a8268] not-italic">— Framework synthesis, 2025</cite>
                </div>
              </div>
            </section>
